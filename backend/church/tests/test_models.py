...
class MembershipConstraintTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user = User.objects.create_user(username="ana", password="x", email="ana@t.com")
        cls.outro = User.objects.create_user(username="bia", password="x", email="bia@t.com")
    ...
    def test_member_com_rede_viola(self):
        self._viola(
            user=self.user, role="member", celula=self.celula, rede=self.rede
        )
    ...
    def test_member_rede_efetiva_derivada_da_celula(self):
        m = Membership.objects.create(
            user=self.user, role="member", celula=self.celula
        )
